import gominsiImg1 from '../assets/images/celebrity/gominsi01.png';
import gominsiImg2 from '../assets/images/celebrity/gominsi02.png';
import gominsiDB1 from './AmbassadorGominsiDB1';
import gominsiDB2 from './AmbassadorGominsiDB2';
import './Gominsi.css';
function Gominsi(){
    return(<>
        <ul className='gominsi_product_wrap'>
            <li>
                <img src={gominsiImg1} alt="" />
